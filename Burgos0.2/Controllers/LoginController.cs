...
namespace Burgos0._2.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            var usuario = await _usuarioService.ObtenerUsuarioPorNombreAsync(
                model.NombreUsuario
            );
            ...
            var hashIntento = PasswordHelper.GenerarPasswordHash(
                model.Password,
                usuario.Salt
            );
            ...
            if (nombreRol != "Administrador" && nombreRol != "Admin")
            {
                ModelState.AddModelError(
                    "",
                    "Acceso denegado: Solo los usuarios con rol Administrador pueden ingresar al sistema."
                );
